...
function getData(){
     ...
     $.ajax({
        ...
        document.getElementById("div-content").innerHTML='<div id="show-cards"><div id="show-cards-top"><p class="item1" style="font-size:calc(15px + 0.5vw);margin-top: 30px;">This is your three-card spread. The cards from left to right represent the past, present, and future.</p><p class="item2" style="font-size:calc(15px + 0.5vw);">Click on each card to know its meaning.</p></div><div id="cards"></div><div><button type="button" class="btn btn-outline-primary" style="margin-top: 10px;color:#ffffff" id="newq" onclick="thirdScreen(this.id);">Ask another question</button></div></div>'; 
        } else {
        document.getElementById("div-content").innerHTML='<div id="show-cards"><div id="show-cards-top"><p class="item1" style="font-size:calc(15px + 0.5vw);margin-top: 30px;">This is your five-card spread. The cards from left to right represent the past, recent past, present, near future, and future.</p><p class="item2" style="font-size:calc(15px + 0.5vw);">Click on each card to know its meaning.</p></div><div id="cards"></div><div><button type="button" class="btn btn-outline-primary" style="margin-top: 10px;color:#ffffff" onclick="thirdScreen();">Ask another question</button></div></div>';    
